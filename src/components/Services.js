      ...
      <section id="services" className="py-20 bg-slate-100">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Service 1 */}
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition duration-300 border border-slate-200">
              <div className="text-orange-400 mb-4">
                <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-2 text-slate-900">Mobile App Development</h3>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition duration-300 border border-slate-200">
              ...
              <h3 className="text-xl font-semibold mb-2 text-slate-900">Web Development</h3>
              <p className="text-slate-600">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition duration-300 border border-slate-200">
              ...
              <h3 className="text-xl font-semibold mb-2 text-slate-900">Custom Software Solutions</h3>
              <p className="text-slate-600">
